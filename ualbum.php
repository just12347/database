...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
            ...
            $sql = "update 專輯 set 專輯名稱 = '$A_name', 發行時間 = $date, 銷售量 = $sales where 專輯ID=$album";
            if($album!=0)
            {
            if(mysql_query($sql)){
            ...
            else
        	{
        		...
        		echo  '<h3>Please choose what alum to update!!</h3><br>';

        	}
            ?>
			<a href="index.php" class="btn" type="button">Back to Index</a>
			<a href="updatealbum.php" class="btn" type="button">Continue Update</a>
			</div>
		</div>
</div>
