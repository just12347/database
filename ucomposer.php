...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			if($composer!=0)
            {	
            $sql = "update 作曲人 set  名稱 = '$Cr_name', 國籍 = $Cr_country where 作詞人ID=$composer";
            if(mysql_query($sql)){
        	...
        	else
        	{
        		...
        		echo  '<h3>Please choose what composer to update!!</h3><br>';

        	}
            ?>
			<a href="index.php" class="btn" type="button">Back to Index</a>
			<a href="updatecomposer.php" class="btn" type="button">Continue Update</a>
			</div>
		</div>
</div>
