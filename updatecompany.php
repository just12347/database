	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
				...
				<form name="form" method="POST" action="ucompany.php">
	                <h3>
	                	 Company Update
	                </h3>
	                <div class="form-group">
	                    <label for="exampleInputSong">Which Company You want to change?</label>
	                    <select class="form-control" name="company">
	                    	<?php
	                        include("mysql_connect.inc.php");
	                        $str="SELECT 公司ID, 公司名 FROM 公司 ";
                    ...
                    <div class="form-group">
                        <label for="exampleInputSong">Company Country</label><input type="text" class="form-control" name="C_country" />
                    </div>
                    <br>
