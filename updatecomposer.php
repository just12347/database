	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
				...
				<form name="form" method="POST" action="ucomposer.php">
	                <h3>
	                	 Composer Update
	                </h3>
	                <div class="form-group">
	                    <label for="exampleInputSong">Which Composer You want to change?</label>
                    ...
                    <div class="form-group">
                        <label for="exampleInputSong">Composer Country</label><input type="text" class="form-control" name="Cr_country" />
                    </div>
                    <br>
