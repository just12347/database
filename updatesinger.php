	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
				...
				<form name="form" method="POST" action="usinger.php">
	                <h3>
	                	 Song Update
	                </h3>
	                <div class="form-group">
	                    <label for="exampleInputSong">Which Singer You want to change?</label>
	                ...
	                <div class="form-group">
                        <label for="exampleInputSong">Singer ID</label><input type="text" class="form-control" name="S_ID" />
                    </div>
	                <div class="form-group">
                        <label for="exampleInputSong">Singer Name</label><input type="text" class="form-control" name="S_name" />
                    </div>
                    <div class="form-group">
                        <label for="exampleInputSinger">Company</label>
