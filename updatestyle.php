	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="row clearfix">
				...
				<form name="form" method="POST" action="ustyle.php">
	                <h3>
	                	 Style Update
	                </h3>
	                <div class="form-group">
	                    <label for="exampleInputSong">Which Style You want to change?</label>
	                    <select class="form-control" name="company">
	                        ...
	                        ?>
	                	                ...
	                	                <div class="form-group">
                        <label for="exampleInputSong">Style Name</label><input type="text" class="form-control" name="Sty_name" />
                    </div>
                    <br>
