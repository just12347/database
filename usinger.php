...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
            ...
            if($singer!=0)
            {	
            $sql = "update 歌手或團體 set  名稱 = '$S_name', 公司ID = $company, 國籍 = '$S_country' where 演唱者ID=$singer";
           ...
           else
        	{
        		...
        		echo  '<h3>Please choose what singer to update!!</h3><br>';

        	}
            ?>
			<a href="index.php" class="btn" type="button">Back to Index</a>
			<a href="updatesinger.php" class="btn" type="button">Continue Update</a>
			</div>
		</div>
</div>
